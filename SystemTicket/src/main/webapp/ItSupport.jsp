    ...
    <div class="container">
        <form name="registrationForm" action="/action_page.php" onsubmit="return validateForm()" method="post">
          <div class="row">
            ...
            <div class="col-75">
              <input type="text" required  id="fname" name="reqname" placeholder="Enter Your name">
            </div>
          </div>
          <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                <input list="Location" name="location" id="location">
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input type="number" id="deskno" name="deskno" placeholder="">
            </div>
          </div>
          <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="text" id="sname" name="site" placeholder="">
            </div>
          </div>   <div class="row">
            <div class="col-25">
          ...
          <div class="row">
            ...
            <div class="col-75">
                <input list="subcat" name="subcatagory" id="subcatagory">
                <datalist id="subcat">
                    ...
                    <option value="User Administration">
                  </datalist>
            </div>
          </div>
          ...
          <div class="row">
          <button><a href="AddReq.jsp"><input type="submit" value="">Add Request</a></button>
